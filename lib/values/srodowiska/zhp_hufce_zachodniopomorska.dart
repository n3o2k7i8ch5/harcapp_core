...
const hufiecBaltyckiKolobrzeg = Hufiec('baltycki_kolobrzeg', 'Bałtycki Hufiec Morski ZHP w Kołobrzegu', choragiewZachodniopomorska);
const hufiecGoleniow = Hufiec('goleniow', 'Hufiec ZHP Goleniów', choragiewZachodniopomorska);
const hufiecMysliborz = Hufiec('mysliborz', 'Hufiec ZHP Myślibórz', choragiewZachodniopomorska);
...
const hufiecSzczecinPogodno = Hufiec('szczecin_pogodno', 'Hufiec ZHP Szczecin-Pogodno im. Janusza Korczaka', choragiewZachodniopomorska);
...
const List<Hufiec> hufceZachodniopomorska = [
  ...
  hufiecSlawno, hufiecStargard, hufiecSzczecin, hufiecSzczecinDabie,
  hufiecSzczecinPogodno, hufiecSzczecinek, hufiecZiemiKoszalinskiej,
  hufiecZiemiWolinskiej,
];
