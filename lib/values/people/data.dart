...
const RegisteredContributor ADAM_DUDAK = RegisteredContributor(
  person: Person(
    name: 'Adam Dudak',
      srodowisko: Srodowisko.hufiec('warszawa_ursynow', showChoragiew: false, showOkreg: false),
      druzyna: '234. Warszawska Drużyna Harcerska „Forteca”',
  ),
  emails: const [],
);
const RegisteredContributor ADAM_KOLADA = RegisteredContributor(
  person: Person(
    name: 'Adam Kołada',
    druzyna: 'III Rogowska Drużyna Harcerzy',
    srodowisko: Srodowisko.hufiec('lodzki_polnoc_harcerzy', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhrWywiadowca,
  ),
  emails: ['adamkolada8@gmail.com', 'adam.kolada@zhr.pl'],
);
...
const RegisteredContributor ADAM_SOBIERAJ = RegisteredContributor(
  person: Person(
    name: 'Adam Sobieraj',
      ...
      srodowisko: Srodowisko.hufiec('jaktorow', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ADAM_WOLOWIEC = RegisteredContributor(
  person: Person(
    name: 'Adam Wołowiec',
...
const RegisteredContributor AGATA_MAJEWSKA = RegisteredContributor(
  person: Person(
    name: 'Agata Majewska',
      srodowisko: Srodowisko.hufiec('lodz_widzew', showChoragiew: false, showOkreg: false),
  ),
  emails: ['agattam2004@gmail.com'],
);
const RegisteredContributor AGATA_MONKO = RegisteredContributor(
  person: Person(
    name: 'Agata Mońko',
  ),
  emails: ['czainak@o2.pl', 'agatamonko123@gmail.com'],
);
const RegisteredContributor AGATA_STALA = RegisteredContributor(
  person: Person(
    name: 'Agata Stala',
    druzyna: '6 ZWDZ "Smerfna Załoga"',
    srodowisko: Srodowisko.custom('ZHP Zgierz'),
    rankHarc: RankHarc.zhpHOd,
    rankInstr: RankInstr.pwd,
  ),
  emails: ['agata.stala@zhp.pl'],
);
const RegisteredContributor AGNIESZKA_DURSKA = RegisteredContributor(
  person: Person(
    name: 'Agnieszka Durska',
      rankInstr: RankInstr.phm,
      srodowisko: Srodowisko.hufiec('lodz_baluty', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
  emails: const [],
);
const RegisteredContributor AGNIESZKA_PIEKARSKA = RegisteredContributor(
  person: Person(
    name: 'Agnieszka Piekarska',
      ...
      srodowisko: Srodowisko.hufiec('szczekocinsko_wloszczowski', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOd,
  ),
...
const RegisteredContributor AGNIESZKA_RADECKA_KUBICKA = RegisteredContributor(
  person: Person(
    name: 'Agnieszka Radecka-Kubicka',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_sanockiej', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ALAN_FILAS = RegisteredContributor(
  person: Person(
    name: 'Alan Filas',
      ...
      srodowisko: Srodowisko.hufiec('poznan_nowe_miasto', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor ALEKSANDER_BIL = RegisteredContributor(
  person: Person(
    name: 'Aleksander Bil',
      ...
      srodowisko: Srodowisko.hufiec('lodzki_polesie_harcerzy', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor ALEKSANDRA_ANTKIEWICZ = RegisteredContributor(
  person: Person(
    name: 'Ola Antkiewicz',
      ...
      srodowisko: Srodowisko.hufiec('grojec', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ALEKSANDRA_CWYNAR = RegisteredContributor(
  person: Person(
    name: 'Aleksandra Cwynar',
      ...
      srodowisko: Srodowisko.hufiec('wroclaw', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
...
const RegisteredContributor ALEKSANDRA_GALIJ = RegisteredContributor(
  person: Person(
    name: 'Ola Galij',
      ...
      srodowisko: Srodowisko.hufiec('bydgoszcz_miasto', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOd,
  ),
...
const RegisteredContributor ALEKSANDRA_KOWALSKA = RegisteredContributor(
  person: Person(
    ...
    druzyna: '17. ZODH',
    srodowisko: Srodowisko.hufiec('zgierz', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ALEKSANDRA_KWAPISZ = RegisteredContributor(
  person: Person(
    name: 'Aleksandra Kwapisz',
      ...
      srodowisko: Srodowisko.hufiec('ostrowiec_swietokrzyski', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOd,
  ),
...
const RegisteredContributor ALEKSANDRA_MISIAK = RegisteredContributor(
  person: Person(
    name: 'Aleksandra Misiak',
      ...
      srodowisko: Srodowisko.hufiec('lodz_baluty', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
...
const RegisteredContributor ALEKSANDRA_TIMM = RegisteredContributor(
  person: Person(
    name: 'Aleksandra Timm',
      druzyna: '21 WDW „Luna”',
      srodowisko: Srodowisko.hufiec('wrzesnia', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor ALEKSANDRA_TKOCZ = RegisteredContributor(
  person: Person(
    name: 'Aleksandra Tkocz',
      ...
      srodowisko: Srodowisko.hufiec('szczecin_dabie', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
...
const RegisteredContributor ALEKSANDRA_WOJCIECHOWSKA = RegisteredContributor(
  person: Person(
    name: 'Aleksandra Wojciechowska',
      srodowisko: Srodowisko.hufiec('plock', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
  emails: ['aleksandra.wojciechowska@zhp.net.pl'],
);
const RegisteredContributor ALIAKSANDR_LAPKOUSKI = RegisteredContributor(
  person: Person(
    name: 'Aliaksandr Lapkouski',
    druzyna: '11 WGDH "Elfy z Doliny Mgieł"',
    srodowisko: Srodowisko.hufiec('wroclaw_polnoc', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpOdkrywca,
  ),
  emails: ['alexlapkovsi@gmail.com', 'aliaksandr.lapkouski@proton.me'],
);
const RegisteredContributor ALICJA_DOBOSZ = RegisteredContributor(
  person: Person(
    name: 'Alicja Dobosz',
      druzyna: '24. GDHS „Boreasz”',
      srodowisko: Srodowisko.hufiec('ziemi_gliwickiej', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor ALICJA_JASINSKA = RegisteredContributor(
  person: Person(
    name: 'Alicja Jasińska',
      ...
      srodowisko: Srodowisko.hufiec('swidnica', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
...
const RegisteredContributor ALICJA_LECIAK = RegisteredContributor(
  person: Person(
    name: 'Alicja Leciak',
  ),
  emails: ['leciakalicja@gmail.com'],
);
...
const RegisteredContributor ALICJA_POROS = RegisteredContributor(
  person: Person(
    name: 'Alicja Poroś',
    druzyna: 'Lisie szeregi',
    srodowisko: Srodowisko.hufiec('powiatu_kaliskiego', custom: 'las', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpOchotniczka,
  ),
  emails: ['alicjaporos13@gmail.com'],
);
const RegisteredContributor AMELIA_BOJARSKA = RegisteredContributor(
  person: Person(
    name: 'Amelia Bojarska',
      druzyna: '1. MDH „Wichry”',
      srodowisko: Srodowisko.hufiec('ostroleka', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
...
const RegisteredContributor AMELIA_SZALEWICZ = RegisteredContributor(
  person: Person(
    name: 'Amelia Szalewicz',
      druzyna: '16. „Astra”',
      srodowisko: Srodowisko.hufiec('lowicz', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
  emails: ['amelia_sz.2010@o2.pl', 'ameliaszalewicz@gmail.com'],
);
const RegisteredContributor ANASTASIA_RESHCHENKO = RegisteredContributor(
  person: Person(
    name: 'Anastasia Reshchenko',
    druzyna: '9RwDW',
  ),
  emails: ['reshchenkoanastasia@gmail.com'],
);
...
const RegisteredContributor ANNA_RAJEWSKA = RegisteredContributor(
  person: Person(
    name: 'Anna Rajewska',
      ...
      srodowisko: Srodowisko.hufiec('kartuzy', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor ANTONINA_CHALINSKA = RegisteredContributor(
  person: Person(
...
const RegisteredContributor ANTONINA_SZTYGLIC = RegisteredContributor(
  person: Person(
    name: 'Antonina Sztyglic',
      srodowisko: Srodowisko.hufiec('lask', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor ANTONI_CHMIELEWSKI = RegisteredContributor(
  person: Person(
...
const RegisteredContributor ANTONI_DEBICKI = RegisteredContributor(
  person: Person(
    name: 'Antoni Dębicki',
    srodowisko: Srodowisko.org('zhp'),
  ),
...
const RegisteredContributor ANTONI_KOSZNIEC = RegisteredContributor(
  ...
  emails: ["antonikoszniec@gmail.com", "narwale662@gmail.com", "koszniecantoni@gmail.com"],
);
const RegisteredContributor ANTONI_RAK = RegisteredContributor(
  person: Person(
    name: 'Antoni Rak',
    druzyna: '1. DDH "Saboty"',
  ),
  emails: ['gazetawyborcza247@gmail.com', 'cegla250@gmail.com'],
);
...
const RegisteredContributor ARTUR_RUSA = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('pulawy', showChoragiew: false, showOkreg: false),
    druzyna: '113. SDSH',
  ),
  emails: const [],
);
const RegisteredContributor ASIA_P = RegisteredContributor(
  person: Person(
    name: 'Asia P',
    druzyna: '7 G.D.H Wilki',
  ),
  emails: ['joanpanec@gmail.com'],
);
...
const RegisteredContributor BARTLOMIEJ_JASKOLSKI = RegisteredContributor(
  person: Person(
    name: 'Bartłomiej Jaskólski',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_tarnogorskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor BARTLOMIEJ_MALYJUREK = RegisteredContributor(
  person: Person(
    name: 'Bartłomiej Małyjurek',
      druzyna: '24. Jodła',
      srodowisko: Srodowisko.hufiec('ziemi_cieszynskiej', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor BARTOSZ_GORECKI = RegisteredContributor(
  person: Person(
...
const RegisteredContributor BARTOSZ_KIERES = RegisteredContributor(
  person: Person(
    name: 'Bartosz Kiereś',
  ),
  emails: ['bartoszkk04@gmail.com'],
);
const RegisteredContributor BARTOSZ_KISIELEWSKI = RegisteredContributor(
  person: Person(
    name: 'Bartosz Kisielewski',
    druzyna: '89.WDS "W drogę"',
    srodowisko: Srodowisko.choragiew('dolnoslaska'),
    rankHarc: RankHarc.zhpWywiadowca,
  ),
  emails: ['bartolok2020@gmail.com'],
);
const RegisteredContributor BARTOSZ_KSIAZEK = RegisteredContributor(
  person: Person(
    name: 'Bartosz Książek',
      druzyna: '91. DHS „Ad Astra”',
      srodowisko: Srodowisko.hufiec('katowice', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHRc,
  ),
  emails: ['bartosz.ksiazek@zhp.net.pl'],
);
const RegisteredContributor BEBENEK_MIKOLAJ = RegisteredContributor(
  person: Person(
    name: 'Bębenek Mikołaj',
    druzyna: '17 hdw smuga cienia',
    srodowisko: Srodowisko.hufiec('jaworzno', showChoragiew: false, showOkreg: false),
  ),
  emails: ['majkiz3.beb@gmail.com'],
);
...
const RegisteredContributor BLAZEJ_INGARDEN = RegisteredContributor(
  person: Person(
...
const RegisteredContributor BLAZEJ_KLEBBA = RegisteredContributor(
  person: Person(
    name: 'Błażej Klebba',
      ...
      srodowisko: Srodowisko.hufiec('puck', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpMlodzik,
  ),
  emails: ['blazej3klebba.onet.pl@gmail.com'],
);
const RegisteredContributor BLAZEJ_PLEWKA = RegisteredContributor(
  person: Person(
    name: 'Błażej Plewka',
    druzyna: '6 TKDH "Grodzianie" w Mrozach',
    srodowisko: Srodowisko.hufiec('mazowsze_minsk', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpMlodzik,
  ),
  emails: ['blazejplewka@gmail.com'],
);
const RegisteredContributor BRUNO_BRONCEL = RegisteredContributor(
  person: Person(
    name: 'Bruno Broncel',
      ...
      srodowisko: Srodowisko.hufiec('karkonoski', showChoragiew: false, showOkreg: false),
  ),
...
RegisteredContributor DAMIAN_DASZYNSKI = const RegisteredContributor(
  person: Person(
    name: 'Damian Daszyński',
    druzyna: '64 Łódzka Drużyna Starszoharcerska "Szpony"',
    srodowisko: Srodowisko.hufiec('lodz_polesie', showOrg: false),
  ),
  emails: ["damian2010poland@gmail.com", "bombodamian388@gmail.com"],
);
...
const RegisteredContributor DANIEL_KORZEB = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('czestochowa', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
const RegisteredContributor DANIEL_KRYSIAK = RegisteredContributor(
  person: Person(
    name: 'Daniel Krysiak',
      ...
      srodowisko: Srodowisko.hufiec('kutno', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor DAWID_KOBEDZA = RegisteredContributor(
  person: Person(
    name: 'Dawid Kobędza',
      ...
      srodowisko: Srodowisko.hufiec('lodz_gorna', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor DAWID_LOBODA = RegisteredContributor(
  person: Person(
    name: 'Dawid Łoboda',
      ...
      srodowisko: Srodowisko.hufiec('gdynski_3_pojutrze_harcerzy', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor DOMINIKA_GORZYNSKA = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('gdansk_srodmiescie', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
...
const RegisteredContributor DOMINIK_BETKA = RegisteredContributor(
  person: Person(
    name: 'Dominik Betka',
      ...
      srodowisko: Srodowisko.hufiec('gdynia', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.phm,
  ),
...
const RegisteredContributor DOMINIK_KIERES = RegisteredContributor(
  person: Person(
    name: 'Dominik Kiereś',
      ...
      srodowisko: Srodowisko.hufiec('wolsztyn', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
  ),
...
const RegisteredContributor DOMINIK_PRZYBYLOWSKI = RegisteredContributor(
  person: Person(
    name: 'Dominik Przybyłowski',
      druzyna: '141. BDW',
      srodowisko: Srodowisko.hufiec('bialystok', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHRc,
  ),
...
const RegisteredContributor DORIAN_JAREK = RegisteredContributor(
  person: Person(
    name: 'Dorian Jarek',
      ...
      srodowisko: Srodowisko.hufiec('konin', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
const RegisteredContributor ECHO_TYL = RegisteredContributor(
  person: Person(
    name: 'Echo Tyl',
  ),
  emails: ['echomotyl@gmail.com'],
);
const RegisteredContributor EFA_BIEDNIAKOWA = RegisteredContributor(
  person: Person(
    name: 'Efa Biedniakowa',
    druzyna: 'Warszawska drużyna harcerska nr. 119 Żoliboz',
  ),
  emails: ['ashesbe1ley@gmail.com'],
);
...
const RegisteredContributor EMILIA_WARSZAJLO = RegisteredContributor(
  person: Person(
    name: 'Emilia Warszajło',
      ...
      srodowisko: Srodowisko.hufiec('poznan_grunwald', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ERYK_UZNANSKI = RegisteredContributor(
  person: Person(
    name: 'Eryk Uznański',
...
const RegisteredContributor EWELINA_HUPKA = RegisteredContributor(
  person: Person(
    name: 'Ewelina Hupka',
      ...
      srodowisko: Srodowisko.hufiec('wegierska_gorka', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
  emails: ['ewelina.hupka@zhp.net.pl'],
);
const RegisteredContributor FEARNE_MILEK = RegisteredContributor(
  person: Person(
    name: 'Fearne Miłek',
    druzyna: '19 DH RatljósT',
    srodowisko: Srodowisko.hufiec('katowice', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpPionierka,
  ),
  emails: ['anna.milek@zhp.net.pl', 'anna.milek@zhp.net.pk'],
);
...
const RegisteredContributor FLORIAN_PELEC = RegisteredContributor(
  person: Person(
    name: 'Florian Pelec',
      ...
      srodowisko: Srodowisko.hufiec('jarocin', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor FRANCISZEK_FALENTA = RegisteredContributor(
  person: Person(
    name: 'Franciszek Falenta',
      ...
      srodowisko: Srodowisko.hufiec('lublin', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor FRANCISZEK_PUKNEL = RegisteredContributor(
  person: Person(
    name: 'Franek Puknel',
      ...
      srodowisko: Srodowisko.hufiec('powiatu_trzebnickiego', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpWywiadowca,
  ),
...
const RegisteredContributor FRANCISZEK_TOMASZCZYK = RegisteredContributor(
  person: Person(
    name: 'Franciszek Tomaszczyk',
      rankHarc: RankHarc.zhpWywiadowca, srodowisko: Srodowisko.hufiec('ziemi_cieszynskiej', showChoragiew: false, showOkreg: false),
...
RegisteredContributor GABRIELA_BRATKIEWICZ = const RegisteredContributor(
  person: Person(
    name: 'Gabriela Bratkiewicz',
    druzyna: '21 WDW Luna',
    srodowisko: Srodowisko.custom('Września WRZOS'),
    rankInstr: RankInstr.pwd,
    rankHarc: RankHarc.zhpPionierka,
  ),
  emails: ["gabriela.bratkiewicz@zhp.net.pl", "gabriela.bratkiewicz07@gmail.com"],
);
const RegisteredContributor GABRIELA_OZOG = RegisteredContributor(
  person: Person(
    name: 'Gabriela Ożóg',
      druzyna: '175. RwDW „Orientalis”',
      srodowisko: Srodowisko.hufiec('rzeszow', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
...
const RegisteredContributor GABRIELA_SAWICKA = RegisteredContributor(
  person: Person(
    name: 'Gabriela Sawicka',
      ...
      srodowisko: Srodowisko.hufiec('bialystok', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor GABRIELA_SOBCZAK = RegisteredContributor(
  person: Person(
    name: 'Gabriela Sobczak',
      druzyna: '10. DH',
      srodowisko: Srodowisko.hufiec('jaktorow', showChoragiew: false, showOkreg: false, showOrg: false),
      rankHarc: RankHarc.zhpOchotniczka,
  ),
...
const RegisteredContributor GABRIEL_POZNANSKI = RegisteredContributor(
  person: Person(
    name: 'Gabriel Poznański',
      ...
      srodowisko: Srodowisko.hufiec('chodziez', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOc,
  ),
  emails: ['gabriel.poznanski455@gmail.com'],
);
const RegisteredContributor GABRIEL_SIOREK = RegisteredContributor(
  person: Person(
    name: 'Gabriel Siorek',
  ),
  emails: ['gabriel.siorek09@gmail.com'],
);
const RegisteredContributor GAJA_TURECKA = RegisteredContributor(
  person: Person(
    name: 'Gaja Turecka',
    druzyna: '71. WDH Iter',
    srodowisko: Srodowisko.hufiec('warszawa_praga_pn', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor GRZEGORZ_BOROWIEC = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('torun', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
const RegisteredContributor GRZEGORZ_FRANK = RegisteredContributor(
  person: Person(
    name: 'Grzegorz Frank',
      srodowisko: Srodowisko.hufiec('ruda_slaska', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOc,
  ),
  emails: ['grzegorz.frank@zhp.net.pl', 'belfermatma@gmail.com', 'szczesniak.ania@wp.pl'],
);
const RegisteredContributor GRZEGORZ_FRANKOW = RegisteredContributor(
  person: Person(
    name: 'Grzegorz Franków',
      ...
      srodowisko: Srodowisko.hufiec('kielce_miasto', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
  ),
...
const RegisteredContributor GRZEGORZ_ZAWADZKI = RegisteredContributor(
  person: Person(
    ...
    druzyna: '8. DSH „Ignis”',
    srodowisko: Srodowisko.hufiec('kutno', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
  emails: const [],
);
const RegisteredContributor GUSTAW_BAJCAR = RegisteredContributor(
  person: Person(
    name: 'Gustaw Bajcar',
      druzyna: '2. WDH',
      srodowisko: Srodowisko.hufiec('olawa', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpMlodzik,
  ),
...
const RegisteredContributor HANNA_RYBACKA = RegisteredContributor(
  person: Person(
    name: 'Hanna Rybacka',
      ...
      srodowisko: Srodowisko.hufiec('zdunska_wola', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpSamarytanka,
      rankInstr: RankInstr.pwd,
  ),
...
const RegisteredContributor HANNA_WNEKOWICZ = RegisteredContributor(
  person: Person(
    name: 'Hanna Wnękowicz',
      ...
      srodowisko: Srodowisko.hufiec('zary', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor HELENA_LATOSINSKA = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('ziemi_wodzislawskiej', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
...
const RegisteredContributor HUGO_HANUSA = RegisteredContributor(
  person: Person(
    name: 'Hugo Hanusa',
      ...
      srodowisko: Srodowisko.hufiec('krakow_stare_miasto_harcerzy', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhrWywiadowca,
  ),
  emails: [
...
const RegisteredContributor IGNACY_KOLTUNIAK = RegisteredContributor(
  person: Person(
    name: 'Ignacy Kołtuniak',
    druzyna: '1 Jarosławska Drużyna Harcerzy "Pościg" im. Jana III Sobieskiego',
    srodowisko: Srodowisko.hufiec('poludniowo_wschodni_grody_harcerzy', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhrCwik,
  ),
  emails: ['ignacykolt534@gmail.com'],
);
const RegisteredContributor IGNACY_LESZCZYNSKI = RegisteredContributor(
  person: Person(
    name: 'Ignacy Leszczyński',
    druzyna: '64 NDSH Abderyci',
    srodowisko: Srodowisko.hufiec('brzeg', showChoragiew: false, showOkreg: false),
  ),
  emails: ['iggnacy12@gmail.com'],
);
...
const RegisteredContributor IGOR_KASPERSKI = RegisteredContributor(
  person: Person(
    name: 'Igor Kasperski',
    srodowisko: Srodowisko.org('zhp'),
    rankHarc: RankHarc.zhpHOc,
...
const RegisteredContributor INGA_WIERZBICKA = RegisteredContributor(
  person: Person(
    name: 'Inga Wierzbicka',
      ...
      srodowisko: Srodowisko.hufiec('krakow_podgorze_harcerek', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhrOchotniczka,
  ),
...
const RegisteredContributor IZABELA_MOSKAL = RegisteredContributor(
  person: Person(
    name: 'Izabela Moskal',
      ...
      srodowisko: Srodowisko.hufiec('krosno', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpSamarytanka,
  ),
...
const RegisteredContributor JAGODA_SKOWRONSKA = RegisteredContributor(
  person: Person(
    name: 'Jagoda Skowrońska',
      druzyna: '125. „Aves”',
      srodowisko: Srodowisko.hufiec('nowe_miasto_lubawskie', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpSamarytanka,
  ),
...
const RegisteredContributor JAKUB_DUDA = RegisteredContributor(
  person: Person(
    name: 'Jakub Duda',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_myszkowskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor JAKUB_GABIS = RegisteredContributor(
  person: Person(
    name: 'Jakub Gabiś',
      ...
      srodowisko: Srodowisko.hufiec('kalisz', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor JAKUB_KLUCZKOWSKI = RegisteredContributor(
  person: Person(
    name: 'Jakub Kluczkowski',
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOc,
      srodowisko: Srodowisko.hufiec('ziemi_koszalinskiej', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor JAKUB_MAGIERA = RegisteredContributor(
  person: Person(
    name: 'Jakub Magiera',
      ...
      srodowisko: Srodowisko.hufiec('nisko', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHRd,
  ),
...
const RegisteredContributor JAKUB_MICHALSKI = RegisteredContributor(
  person: Person(
    name: 'Jakub Michalski',
      ...
      srodowisko: Srodowisko.hufiec('pabianice', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor JAKUB_NOWAKOWSKI = RegisteredContributor(
  person: Person(
    name: 'pwd. Jakub Nowakowski',
  ),
  emails: ['jakub.nowakowski1@zhp.net.pl'],
);
const RegisteredContributor JAKUB_SIKORA = RegisteredContributor(
  person: Person(
    name: 'Jakub Sikora',
    druzyna: '2. DH Sokoły',
...
RegisteredContributor JAKUB_SMYK = const RegisteredContributor(
  person: Person(
    name: 'Jakub Smyk',
    druzyna: '102. WDW "Rudy"',
    srodowisko: Srodowisko.hufiec('wagrowiec'),
    rankInstr: RankInstr.pwd,
    rankHarc: RankHarc.zhpHOc,
  ),
  emails: ["jakub.smyk@zhp.net.pl", "jakubsmyk23@gmail.com"],
);
...
const RegisteredContributor JAKUB_STRACZYNSKI = RegisteredContributor(
  person: Person(
    name: 'Jakub Strączyński',
      druzyna: '52. KDHS',
      srodowisko: Srodowisko.hufiec('kielce_miasto', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor JAN_MYSZCZYSZYN = RegisteredContributor(
  person: Person(
    name: 'Jan Myszczyszyn',
    druzyna: '205 WDH AdReM',
    srodowisko: Srodowisko.hufiec('warszawa_praga_pn', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpHOc,
    rankInstr: RankInstr.pwd,
  ),
  emails: ['myszyn08@gmail.com'],
);
const RegisteredContributor JAN_NOWAK = RegisteredContributor(
  person: Person(
    name: 'Jan Nowak',
      druzyna: '8. UDH „Knieja”',
      srodowisko: Srodowisko.hufiec('ursynowski_rawicz_harcerzy', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
RegisteredContributor JAN_SUROWKA = const RegisteredContributor(
  person: Person(
    name: 'Jan Surówka',
    srodowisko: Srodowisko.org('zhp'),
    rankHarc: RankHarc.dhc,
  ),
  emails: ["jsrwka@gmail.com"],
);
...
const RegisteredContributor JAROSLAW_JAKUBIAK = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('wilno_uk', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
  emails: const [],
);
const RegisteredContributor JAROSLAW_ZASACKI = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('zielonogorski_topor_harcerzy', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
const RegisteredContributor JASMINA_ROZYCKA = RegisteredContributor(
  person: Person(
    name: 'Jaśmina Różycka',
      ...
      srodowisko: Srodowisko.hufiec('lubelski_harmonia_harcerek', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhrSamarytanka,
  ),
...
const RegisteredContributor JERZY_ZOLNA = RegisteredContributor(
  person: Person(
    name: 'Jerzy Żołna',
      ...
      srodowisko: Srodowisko.hufiec('poznan_stare_miasto', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor JOWITA_BUCZYNSKA = RegisteredContributor(
  person: Person(
    name: 'Jowita Buczyńska',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_bedzinskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
...
const RegisteredContributor JULIAN_SLAZYK = RegisteredContributor(
  person: Person(
    name: 'Julian Ślazyk',
      druzyna: '47. ŁWDW',
      srodowisko: Srodowisko.hufiec('lodz_polesie', showChoragiew: false, showOkreg: false, showOrg: false),
      rankHarc: RankHarc.dhd,
  ),
  emails: ['l.z.slazyk@gmail.com', 'podstawczak0@gmail.com'],
);
RegisteredContributor JULIAN_WANICZEK = const RegisteredContributor(
  person: Person(
    name: 'Julian Waniczek',
    druzyna: '8. DW „AZYL”',
    srodowisko: Srodowisko.hufiec('luzycki', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.dhc,
  ),
  emails: ["julian.waniczek@zhp.pl"],
);
const RegisteredContributor JULIA_BENEDYK = RegisteredContributor(
  person: Person(
    name: 'Julia Benedyk',
      druzyna: '9. MDH',
      srodowisko: Srodowisko.hufiec('mielec', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpTropicielka,
  ),
...
const RegisteredContributor JULIA_GRODZKA = RegisteredContributor(
  person: Person(
    name: 'Julka Grodzka',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_rybnickiej', showChoragiew: false, showOkreg: false, showOrg: false),
      rankHarc: RankHarc.zhpSamarytanka,
  ),
...
const RegisteredContributor JULIA_MACIAG = RegisteredContributor(
  person: Person(
    name: 'Julia Maciąg',
    rankHarc: RankHarc.zhpPionierka,
...
const RegisteredContributor JULIA_PIASKOWSKA = RegisteredContributor(
  person: Person(
    name: 'Julia Piaskowska',
      ...
      srodowisko: Srodowisko.hufiec('tomaszow_mazowiecki', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpTropicielka,
  ),
...
const RegisteredContributor KACPER_CIESIELSKI = RegisteredContributor(
  person: Person(
    name: 'Kacper Ciesielski',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_wolinskiej', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHRc,
  ),
...
const RegisteredContributor KACPER_OLEJNIK = RegisteredContributor(
  person: Person(
    name: 'Kacper Olejnik',
      ...
      srodowisko: Srodowisko.hufiec('lubaczow', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor KACPER_TRUCHLEWSKI = RegisteredContributor(
  person: Person(
    name: 'Kacper Truchlewski',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_mikolowskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor KAJETAN_RUSZKOWSKI = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('lodzki_szaniec_harcerzy', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpHOc,
  ),
  emails: const [],
);
const RegisteredContributor KAJETAN_WITKOWSKI = RegisteredContributor(
  person: Person(
    name: 'Kajetan Witkowski',
      druzyna: '2. DH Iskry',
      srodowisko: Srodowisko.hufiec('miedzyrzecz', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpMlodzik,
  ),
...
const RegisteredContributor KALINA_KAWICZ = RegisteredContributor(
  person: Person(
    name: 'Kalina Kawicz',
...
const RegisteredContributor KAMIL_ORGANISTA = RegisteredContributor(
  person: Person(
    name: 'Kamil Organista',
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOc,
      srodowisko: Srodowisko.hufiec('zamosc', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor KAROLINA_HAJDUK = RegisteredContributor(
  person: Person(
    name: 'Karolina Hajduk',
      druzyna: '21. DH',
      srodowisko: Srodowisko.hufiec('bytom', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpOchotniczka,
  ),
...
const RegisteredContributor KAROLINA_MROCZKO = RegisteredContributor(
  person: Person(
    name: 'Karolina Mroczko',
      ...
      srodowisko: Srodowisko.hufiec('lagiewniki', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpOchotniczka,
  ),
...
const RegisteredContributor KAROLINA_WISNIEWSKA = RegisteredContributor(
  person: Person(
    name: 'Karolina Wiśniewska',
      ...
      srodowisko: Srodowisko.hufiec('podlasie_siedlce', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor KAROL_FROST = RegisteredContributor(
  person: Person(
    name: 'Karol Frost',
      ...
      srodowisko: Srodowisko.hufiec('starogard_gdanski', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor KAROL_PODOLSKI = RegisteredContributor(
  person: Person(
    name: 'Karol Podolski',
      ...
      srodowisko: Srodowisko.hufiec('ilawa', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
  ),
...
const RegisteredContributor KATARZYNA_JEDRZEJCZYK = RegisteredContributor(
  person: Person(
...
const RegisteredContributor KINGA_JANKO = RegisteredContributor(
  person: Person(
    name: 'K. Janko',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_tarnogorskiej', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor KINGA_KONOPCZYNSKA = RegisteredContributor(
  person: Person(
    name: 'Kinga Konopczyńska',
      druzyna: '29. WDCzB',
      srodowisko: Srodowisko.hufiec('rumia', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHRd,
  ),
...
const RegisteredContributor KLAUDIA_PARNIEWICZ = RegisteredContributor(
  person: Person(
    name: 'Klaudia Parniewicz',
      ...
      srodowisko: Srodowisko.hufiec('nowy_tomysl', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOd,
  ),
...
const RegisteredContributor KLAUDIA_STASINSKA = RegisteredContributor(
  person: Person(
    name: 'Klaudia Stasińska',
      ...
      srodowisko: Srodowisko.hufiec('poznan_nowe_miasto', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor KORNELIA_KASIBORSKA = RegisteredContributor(
  person: Person(
    name: 'Kornelia Kasiborska',
      ...
      srodowisko: Srodowisko.hufiec('wloclawek', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
...
const RegisteredContributor KORNELIA_MROWKA = RegisteredContributor(
  person: Person(
    name: 'Kornelia Mrówka',
      ...
      srodowisko: Srodowisko.hufiec('miedzychod', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
...
const RegisteredContributor KORNEL_DABKOWSKI = RegisteredContributor(
  person: Person(
    name: 'Kornel Dąbkowski',
      ...
      srodowisko: Srodowisko.hufiec('trzcianka', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor KRZESIMIR_KARBOWNIK = RegisteredContributor(
  ...
  emails: ['krzesimir@karbownik.org', 'krzesimir.karbownik@zhp.pl'],
);
...
const RegisteredContributor LENA_DOLECKA = RegisteredContributor(
  person: Person(
    name: 'Lena Dolecka',
    druzyna: '8 Mełgiewska Drużyna Harcerek “Przystań”',
    srodowisko: Srodowisko.hufiec('lubelski_rzeka_harcerek', showChoragiew: false, showOkreg: false, showOrg: false),
    rankHarc: RankHarc.zhrTropicielka,
  ),
  emails: ['lenadolecka1@gmail.com', 'hania.gos@interia.pl'],
);
...
const RegisteredContributor LENA_ULINSKA = RegisteredContributor(
  person: Person(
    name: 'Lena Ulińska',
    druzyna: '111. ADH',
    srodowisko: Srodowisko.hufiec('starachowice', showChoragiew: false, showOkreg: false),
...
RegisteredContributor LILA_KULAGOWSKA = const RegisteredContributor(
  person: Person(
    name: 'Lila Kułagowska',
    druzyna: '10 Harcerska drużyna żeglarska',
    srodowisko: Srodowisko.hufiec('katowice'),
    rankHarc: RankHarc.zhpOchotniczka,
  ),
  emails: ["liliana080513@gmail.com"],
);
const RegisteredContributor LILIANA_KASPRZYK = RegisteredContributor(
  person: Person(
    name: 'Liliana Kasprzyk',
      druzyna: '9 GDHS Lukarna',
      srodowisko: Srodowisko.hufiec('ziemi_gliwickiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
  emails: ['lilka.kasprzyk@gmail.com'],
);
const RegisteredContributor LILIANA_MATUSZYK = RegisteredContributor(
  person: Person(
    name: 'Liliana Matuszyk',
    druzyna: 'Boreasz',
    srodowisko: Srodowisko.hufiec('ziemi_gliwickiej', custom: 'Róża wiatrów', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.dhd,
  ),
  emails: ['fhuinzynier@gmail.com'],
);
const RegisteredContributor LILIANA_MIROTA = RegisteredContributor(
  person: Person(
    name: 'Liliana Mirota',
      druzyna: '7. BDH „Wrzosowisko”',
      srodowisko: Srodowisko.hufiec('reduta', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpOchotniczka,
  ),
  emails: ['lilianamirota@gmail.com', 'lilianokotek@wp.pl'],
);
const RegisteredContributor LUCIANO_COSTA = RegisteredContributor(
  person: Person(
    name: 'Luciano Costa',
  ),
...
const RegisteredContributor LUKASZ_STROZYK = RegisteredContributor(
  person: Person(
    name: 'Łukasz Stróżyk',
      ...
      srodowisko: Srodowisko.hufiec('wagrowiec', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor LUKASZ_SZTANDERA = RegisteredContributor(
  person: Person(
    name: 'Łukasz Sztandera',
      rankHarc: RankHarc.zhpWywiadowca,
      srodowisko: Srodowisko.hufiec('kielce_poludnie', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor LUKASZ_WERNIK = RegisteredContributor(
  person: Person(
    name: 'Łukasz Wernik',
      ...
      srodowisko: Srodowisko.hufiec('gostynin', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor MACIEJ_DOBROWOLSKI = RegisteredContributor(
  person: Person(
    name: 'Maciej Dobrowolski',
      srodowisko: Srodowisko.hufiec('elblag', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.phm,
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor MACIEJ_KOLAKOWSKI = RegisteredContributor(
  person: Person(
    name: 'Maciej Kołakowski',
      druzyna: '97. DSh',
      srodowisko: Srodowisko.hufiec('zywiec', showChoragiew: false, showOkreg: false),
  ),
  emails: ['maciej.kolakowski@zhp.net.pl'],
);
RegisteredContributor MACIEK_KUZAWINSKI = const RegisteredContributor(
  person: Person(
    name: 'Maciek Kuzawiński',
    srodowisko: Srodowisko.org('sh'),
    rankInstr: RankInstr.pwd,
    rankHarc: RankHarc.zhrHOc,
  ),
  emails: ["mkuzawinski@sh.org.pl", "maciekkuzawinski@gmail.com"],
);
...
const RegisteredContributor MACIEJ_W = RegisteredContributor(
  person: Person(
    name: 'Maciej W.',
  ),
  emails: ['maciejwnuk12@gmail.com'],
);
...
const RegisteredContributor MAGDALENA_BINIAK = RegisteredContributor(
  person: Person(
    name: 'Magdalena Biniak',
    druzyna: '5 wdh im. Floriana Marciniaka we Wronkach',
    srodowisko: Srodowisko.hufiec('szamotuly', showChoragiew: false, showOkreg: false),
  ),
  emails: ['magdalena2013b@gmail.com'],
);
...
const RegisteredContributor MAJA_SAWICKA = RegisteredContributor(
  person: Person(
    name: 'Maja Sawicka',
...
const RegisteredContributor MARCEL_CHRZASCIK = RegisteredContributor(
  person: Person(
...
const RegisteredContributor MARCEL_MICHALIK = RegisteredContributor(
  person: Person(
    name: 'Marcel Michalik',
      ...
      srodowisko: Srodowisko.hufiec('glogow', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor MARCIN_KOWALICKI = RegisteredContributor(
  person: Person(
...
const RegisteredContributor MARCIN_SOBKOWICZ = RegisteredContributor(
  person: Person(
    name: 'Marcin Sobkowicz',
      ...
      srodowisko: Srodowisko.hufiec('opole', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor MAREK_PRZYBYLA = RegisteredContributor(
  person: Person(
    name: 'Marek Przybyła',
    druzyna: '28. ŁDH',
  ...
  emails: ["rzecznykamien@gmail.com", "marusprzybyla@gmail.com"],
);
...
const RegisteredContributor MARIA_LAKOMA = RegisteredContributor(
  person: Person(
    name: 'Maria Łakoma',
      ...
      srodowisko: Srodowisko.hufiec('doliny_liwca', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOd,
  ),
...
RegisteredContributor MARIAN_KWIECIEN = const RegisteredContributor(
  person: Person(
    name: 'Marian Kwiecień',
    druzyna: '34 RDHS "Meksyk 2"',
    srodowisko: Srodowisko.org('zhp'),
    rankInstr: RankInstr.hm,
    rankHarc: RankHarc.zhpHRc,
  ),
  emails: ["d.lordunio@onet.eu", "d.kolasinski@psp34.radom.pl"],
);
...
const RegisteredContributor MARYSIA_SLUGAJ = RegisteredContributor(
  person: Person(
    name: 'Marysia Ślugaj',
      rankHarc: RankHarc.zhpHOd,
      srodowisko: Srodowisko.hufiec('wrzesnia', showChoragiew: false, showOkreg: false, showOrg: false),
      druzyna: '77. Wrzesińska Drużyna Wędrownicza „Huragan”',
  ),
...
const RegisteredContributor MATEUSZ_D = RegisteredContributor(
  person: Person(
    name: 'Mateusz D',
      druzyna: '2. BDH „Rajza”',
      srodowisko: Srodowisko.hufiec('bytomski_zdh_harcerzy', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhrWywiadowca,
  ),
  emails: ['matiadormateusz@gmail.com'],
);
const RegisteredContributor MATEUSZ_DYDO = RegisteredContributor(
  person: Person(
    name: 'Mateusz Dydo',
  ),
  emails: ['mateusz.dydo11@gmail.com'],
);
...
const RegisteredContributor MATEUSZ_KOBYLAREK = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('poznan_wilda', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
...
const RegisteredContributor MATEUSZ_MIKLASZEWSKI = RegisteredContributor(
  person: Person(
    name: 'Mateusz Miklaszewski',
      druzyna: '12. DH Silva',
      srodowisko: Srodowisko.hufiec('augustow', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor MATEUSZ_WAS = RegisteredContributor(
  person: Person(
    name: 'Mateusz Wąs',
      ...
      srodowisko: Srodowisko.hufiec('klobuck', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor MATVII_MASLOVSKYI = RegisteredContributor(
  person: Person(
    name: 'Матвій Масловскi',
      druzyna: '6. DSH',
      srodowisko: Srodowisko.hufiec('gniezno', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor MATYLDA_OLEJNIK = RegisteredContributor(
  person: Person(
    name: 'Matylda Olejnik',
      druzyna: 'V DH Impsa',
      srodowisko: Srodowisko.hufiec('kedzierzyn_kozle', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor MICHAL_CHOLEWCZYNSKI = RegisteredContributor(
  person: Person(
    name: 'Michał Cholewczyński',
      ...
      srodowisko: Srodowisko.hufiec('poznan_jezyce', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor MICHAL_MACULEWICZ = RegisteredContributor(
  person: Person(
    name: 'Michał Maculewicz',
      ...
      rankHarc: RankHarc.zhpHOc,
      srodowisko: Srodowisko.hufiec('nidzica', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor MICHAL_SITEK = RegisteredContributor(
  person: Person(
    name: 'Michał Sitek',
      ...
      srodowisko: Srodowisko.hufiec('chrzanow', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor MICHAL_ZAJAC = RegisteredContributor(
  person: Person(
    name: 'Michał Zając',
    druzyna: '1 Włodawska Drużyna Harcerzy „Delta”',
    srodowisko: Srodowisko.hufiec('poleski_swit_harcerzy', showChoragiew: false, showOkreg: false),
  ),
  emails: ['michalzajac1605@gmail.com'],
);
...
const RegisteredContributor MIKOLAJ_HORDEJUK = RegisteredContributor(
  person: Person(
    name: 'Mikołaj Hordejuk',
      ...
      srodowisko: Srodowisko.hufiec('mazowiecki_pogranicze_harcerzy', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhrMlodzik,
  ),
...
const RegisteredContributor MIKOLAJ_SOBON = RegisteredContributor(
  person: Person(
    name: 'Mikołaj Soboń',
      ...
      srodowisko: Srodowisko.hufiec('zyrardow', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.phm,
      rankHarc: RankHarc.zhpHRc,
  ),
...
const RegisteredContributor MILENA_NOWICKA = RegisteredContributor(
  person: Person(
    name: 'Milena Nowicka',
      ...
      srodowisko: Srodowisko.hufiec('biala_podlaska', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
...
const RegisteredContributor NADIA_STOLAR = RegisteredContributor(
  person: Person(
    name: 'Nadia Stolar',
      druzyna: '41. TDH „Astrum”',
      srodowisko: Srodowisko.hufiec('tomaszow_mazowiecki', showChoragiew: false, showOkreg: false, showOrg: false),
      rankHarc: RankHarc.zhpOchotniczka,
  ),
...
const RegisteredContributor NAPEWNO_NIEBRONIEWSKI = RegisteredContributor(
  person: Person(
...
const RegisteredContributor NATALIA_KLEPACKA = RegisteredContributor(
  person: Person(
    name: 'Natalia Klepacka',
      ...
      srodowisko: Srodowisko.hufiec('wroclaw_polnoc', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor NATALIA_STODOLNA = RegisteredContributor(
  person: Person(
    name: 'Natalia Stodolna',
      ...
      srodowisko: Srodowisko.hufiec('zielona_gora', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpSamarytanka,
  ),
  emails: ['natalia.stodolna@zhp.net.pl'],
);
const RegisteredContributor NATALIA_STRZELECKA = RegisteredContributor(
  person: Person(
    name: 'Natalia Strzelecka',
    druzyna: '41 PDH "Orle Gniazdo" im. Olgi Drahonowskiej-Małkowskiej',
    srodowisko: Srodowisko.hufiec('pionkowski_darzbor_harcerek', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhrSamarytanka,
  ),
  emails: ['nstrzelecka15@gmail.com', 'strzeleckanatalia@gmail.com', 'strzeleckanatalia@zhr.pl'],
);
...
const RegisteredContributor NATALIA_WOJTYCZKA = RegisteredContributor(
  person: Person(
    name: 'Natalia Wojtyczka',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_tyskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
  emails: ['nataliawojtyczka00@gmail.com'],
);
const RegisteredContributor NATHAN_JULIAN_LEWKOWICZ = RegisteredContributor(
  person: Person(
    name: 'Nathan Julian Lewkowicz',
    druzyna: '6 KDW Lux in Tenebris',
    srodowisko: Srodowisko.hufiec('ketrzyn', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpCwik,
  ),
  emails: ['nathan.lewkowicz@zhp.pl', 'nathan.lewkowicz07@gmail.com'],
);
const RegisteredContributor NATASZA_OLSZANSKA = RegisteredContributor(
  person: Person(
    name: 'Natasza Olszańska',
      ...
      srodowisko: Srodowisko.hufiec('mielec', showChoragiew: false, showOkreg: false, showOrg: false),
      rankHarc: RankHarc.zhpTropicielka,
  ),
...
const RegisteredContributor NINA_GACEK = RegisteredContributor(
  person: Person(
    name: 'Nina Gacek',
    druzyna: '32. DSH „Przeszczep hydrauliczny”',
    srodowisko: Srodowisko.hufiec('krzeszowice', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpOchotniczka,
  ),
  emails: ['nina.gacek@icloud.com'],
);
...
const RegisteredContributor OLGA_LUCZAK = RegisteredContributor(
  person: Person(
    name: 'Olga Łuczak',
      ...
      srodowisko: Srodowisko.hufiec('sieradz', showChoragiew: false, showOkreg: false),
  ),
  emails: ['oluczak390@gmail.com'],
);
RegisteredContributor OLIWER_DARA = const RegisteredContributor(
  person: Person(
    name: 'Oliwer Dara',
    druzyna: '335 KDSH „Niewidzialni”',
    srodowisko: Srodowisko.hufiec('krakow_nowa_huta', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpOdkrywca,
  ),
  emails: ["naprawskifranciszek@gmail.com", "fnapraw@icloud.com"],
);
const RegisteredContributor OLIWIA_MAJDA = RegisteredContributor(
  person: Person(
    name: 'Oliwia Majda',
      ...
      srodowisko: Srodowisko.hufiec('wejherowo', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor PATRYCJA_KALINOWSKA = RegisteredContributor(
  person: Person(
    name: 'Patrycja Kalinowska',
      rankHarc: RankHarc.zhpPionierka,
      srodowisko: Srodowisko.hufiec('zory', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor PATRYCY_TUBACKI_BLASZCZYK = RegisteredContributor(
  person: Person(
    name: 'Patrycy Tubacki-Błaszczyk',
    druzyna: '25 DH Buki',
    srodowisko: Srodowisko.hufiec('gniezno', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.dhc,
  ),
  emails: ['patrycy.tb@gmail.com'],
);
...
const RegisteredContributor PAWEL = RegisteredContributor(
  person: Person(
    name: 'Paweł',
    rankHarc: RankHarc.zhpHOc,
  ),
  emails: ['pawel.re.28@gmail.com'],
);
...
const RegisteredContributor PAWEL_SZCZYGIEL = RegisteredContributor(
  person: Person(
    name: 'Paweł Szczygieł',
      ...
      srodowisko: Srodowisko.hufiec('radom_miasto', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor PIOTR_GASIOR = RegisteredContributor(
  person: Person(
    name: 'Piotr Gąsior',
      ...
      srodowisko: Srodowisko.hufiec('myslowice', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor RAFAL_RZEPA = RegisteredContributor(
  person: Person(
    name: 'Rafał Rzepa',
  ),
  emails: ['rzeparafal4@gmail.com'],
);
const RegisteredContributor REMIGIUSZ_AJCHSZTET = RegisteredContributor(
  person: Person(
    name: 'Remigiusz Ajchsztet',
    druzyna: '27 Harcerska Dróżyna Wodna',
    srodowisko: Srodowisko.hufiec('ziemi_mikolowskiej', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpWywiadowca,
  ),
  emails: ['remekajchajch@gmail.com', 'ajchsztet.r@gmail.com'],
);
const RegisteredContributor ROBERT_LISZEWSKI = RegisteredContributor(
  person: Person(
    name: 'Robert Liszewski',
      ...
      srodowisko: Srodowisko.hufiec('sochaczew', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor ROBERT_LOPATKA = RegisteredContributor(
  person: Person(
    name: 'Robert Łopatka',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_zywieckiej', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHRc,
  ),
...
const RegisteredContributor RYSZARD_BIENIAS_6_TKDH_MROZY = RegisteredContributor(
  person: Person(
    name: 'Ryszard Bienias 6 TKDH Mrozy',
  ),
  emails: ['ryszardbienias00@gmail.com'],
);
...
const RegisteredContributor SAM_MAJA_PLOMINSKA = RegisteredContributor(
  person: Person(
    name: 'sam. Maja Płomińska',
  ),
  emails: ['majekplominek@gmail.com'],
);
...
const RegisteredContributor SEBASTIAN_KOPROWSKI = RegisteredContributor(
  person: Person(
    name: 'Stanisław Koprowski',
      ...
      srodowisko: Srodowisko.hufiec('brodnica', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor SEBASTIAN_SUGALSKI = RegisteredContributor(
  person: Person(
    ...
    srodowisko: Srodowisko.hufiec('ziemi_koszalinskiej', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor STANISLAW_KUDLA = RegisteredContributor(
  person: Person(
    name: 'Stanisław Kudła',
    druzyna: '27 „Zmrok”',
    srodowisko: Srodowisko.custom('ZHP Zielonka'),
  ),
  emails: ['stasiek.kudla@gmail.com'],
);
...
const RegisteredContributor STANISLAW_WOJCIECHOWSKI = RegisteredContributor(
  person: Person(
    name: 'Stanisław Wojciechowski',
      ...
      srodowisko: Srodowisko.hufiec('ostrow_wielkopolski', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor STEFA_RECZEK = RegisteredContributor(
  person: Person(
    name: 'Stefa Reczek',
    druzyna: '413 WDW Legion XII Fulminata',
    rankHarc: RankHarc.zhpHOd,
  ),
  emails: ['stefrecz@gmail.com', 'stefania.reczek@zhp.net.pl'],
);
...
const RegisteredContributor STEFAN_PACIOREK = RegisteredContributor(
  person: Person(
...
const RegisteredContributor SZYMON_BRODA = RegisteredContributor(
  person: Person(
    name: 'Szymon Broda',
...
const RegisteredContributor SZYMON_DROPEK = RegisteredContributor(
  person: Person(
    name: 'Szymon Dropek',
      ...
      srodowisko: Srodowisko.hufiec('kwidzyn', showChoragiew: false, showOkreg: false),
      rankInstr: RankInstr.pwd,
      rankHarc: RankHarc.zhpHOc,
  ),
...
const RegisteredContributor SZYMON_KLIMUNTOWSKI = RegisteredContributor(
  person: Person(
    name: 'Szymon Klimuntowski',
      druzyna: '7. DH „Iskra”',
      srodowisko: Srodowisko.hufiec('ziemi_dzierzoniowskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
const RegisteredContributor SZYMON_PADOK = RegisteredContributor(
  person: Person(
    name: 'Szymon Padok',
      ...
      srodowisko: Srodowisko.hufiec('gorzow_wielkopolski', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpCwik,
  ),
...
const RegisteredContributor SZYMON_TRZONKOWSKI = RegisteredContributor(
  person: Person(
    name: 'Szymon Trzonkowski',
    druzyna: 'XV GWDH ex. ,,AMMEDA" im. Tadeusza Zawadzkiego',
    srodowisko: Srodowisko.hufiec('elk', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpOdkrywca,
  ),
  emails: ['szymontrzonkowski0@gmail.com'],
);
...
const RegisteredContributor TOMASZ_FLORCZAK = RegisteredContributor(
  person: Person(
    name: 'Tomasz Florczak',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_przemyskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhc,
  ),
...
RegisteredContributor TOMASZ_KOZA = const RegisteredContributor(
  person: Person(
    name: 'Tomasz Koza',
    srodowisko: Srodowisko.org('zhp'),
    rankHarc: RankHarc.dhc,
  ),
  emails: ["koza.tomasz.13@gmail.com"],
);
...
const RegisteredContributor TYTUS_LIPKA = RegisteredContributor(
  person: Person(
    name: 'Tytus Lipka',
    druzyna: '50 DSH Twierdza',
    srodowisko: Srodowisko.hufiec('wroclaw', showChoragiew: false, showOkreg: false),
  ),
  emails: ['tytusslonio505@gmail.com'],
);
...
const RegisteredContributor VICTORIA_TROCZYNSKA = RegisteredContributor(
  person: Person(
...
const RegisteredContributor VIVIENNE_FALKOWSKA = RegisteredContributor(
  person: Person(
    name: 'Vivienne Falkowska',
    druzyna: '21 Wędrownicza Drużyna "Beboki"',
    srodowisko: Srodowisko.hufiec('piekary_slaskie', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpSamarytanka,
  ),
  emails: ['falkowskavivienne18@gmail.com'],
);
const RegisteredContributor WANDA_MARCHEL = RegisteredContributor(
  person: Person(
    name: 'Wanda Marchel',
      ...
      srodowisko: Srodowisko.hufiec('opole', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
const RegisteredContributor WERONIKA_IWANISZYN = RegisteredContributor(
  person: Person(
    name: 'Weronika Iwaniszyn',
      ...
      srodowisko: Srodowisko.hufiec('ziemi_walbrzyskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.dhd,
  ),
...
const RegisteredContributor WERONIKA_PUSCIAN = RegisteredContributor(
  person: Person(
    name: 'Weronika Puścian',
      ...
      srodowisko: Srodowisko.hufiec('brodnica', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpSamarytanka,
  ),
...
const RegisteredContributor WIKTORIA_BECHERKA = RegisteredContributor(
  person: Person(
...
const RegisteredContributor WIKTORIA_PINKOWSKA = RegisteredContributor(
  person: Person(
    name: 'Wiktoria Pinkowska',
      ...
      srodowisko: Srodowisko.hufiec('zgierz', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor WIKTOR_KOWALCZUK = RegisteredContributor(
  person: Person(
    name: 'Wiktor Kowalczuk',
      druzyna: '2. WDH „Aves”',
      srodowisko: Srodowisko.hufiec('olecko', showChoragiew: false, showOkreg: false, showOrg: false),
  ),
...
const RegisteredContributor WOJCIECH_BOSOWSKI = RegisteredContributor(
  person: Person(
    name: 'Wojciech Bosowski',
    druzyna: '4 JDH "Palmiry"',
    srodowisko: Srodowisko.hufiec('jordanow', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpHOc,
  ),
  emails: ['wojciech.bosowski@zhp.pl', 'longfengbasingsee@gmail.com'],
);
...
const RegisteredContributor WOJCIECH_PONIEWSKI = RegisteredContributor(
  person: Person(
...
const RegisteredContributor WOJCIECH_SOBOL = RegisteredContributor(
  person: Person(
    name: 'Wojciech Soból',
    druzyna: '7MDH "Wypustki" im. Kazimierza Sobolewskiego',
    srodowisko: Srodowisko.hufiec('myslenice', showChoragiew: false, showOkreg: false),
  ),
  emails: ['wojtech08@gmail.com', 'wojciech.sobol@zhp.pl'],
);
...
const RegisteredContributor WOJTEK_KRAWIEC = RegisteredContributor(
  person: Person(
    name: 'Wojtek Krawiec',
    druzyna: '9. MDH Wawer',
    srodowisko: Srodowisko.hufiec('milicz', showChoragiew: false, showOkreg: false),
...
RegisteredContributor ZASTEP_SWAROGI = const RegisteredContributor(
  person: Person(
    name: 'Zastęp Swarogi',
    srodowisko: Srodowisko.hufiec('wolomin', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpTropicielka,
  ),
  emails: ["zejmo.lucja@gmail.com"],
);
...
const RegisteredContributor ZUZANNA_GRZESIAK = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Grzesiak',
      srodowisko: Srodowisko.hufiec('kepno', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ZUZANNA_JANKOWSKA = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Jankowska',
      ...
      srodowisko: Srodowisko.hufiec('paluki', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpPionierka,
  ),
...
const RegisteredContributor ZUZANNA_KOWALCZYK = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Kowalczyk',
      rankHarc: RankHarc.zhpOchotniczka,
      srodowisko: Srodowisko.hufiec('stargard', showChoragiew: false, showOkreg: false),
...
const RegisteredContributor ZUZANNA_MIERZEJEWSKA = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Mierzejewska',
      ...
      srodowisko: Srodowisko.hufiec('luban', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
...
const RegisteredContributor ZUZANNA_PIWKO = RegisteredContributor(
  person: Person(
    name: 'Zuza Piwko',
      ...
      srodowisko: Srodowisko.hufiec('wroclaw_wschod', showChoragiew: false, showOkreg: false),
  ),
...
const RegisteredContributor ZUZANNA_RADKOWSKA = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Radkowska',
      druzyna: '21. ZDH',
      srodowisko: Srodowisko.hufiec('ziemi_zawiercianskiej', showChoragiew: false, showOkreg: false),
      rankHarc: RankHarc.zhpTropicielka,
  ),
...
const RegisteredContributor ZUZANNA_SZYSZKA = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Szyszka',
    druzyna: '4ŁDH Niewidzialna Ręka',
    srodowisko: Srodowisko.hufiec('paluki', showChoragiew: false, showOkreg: false),
    rankHarc: RankHarc.zhpOchotniczka,
  ),
  emails: ['zuziaszyszka8@icloud.com'],
);
const RegisteredContributor ZUZANNA_WARCHOL = RegisteredContributor(
  person: Person(
    name: 'Zuzanna Warchoł',
      druzyna: '113. TWDH „Pustynna Burza”',
      srodowisko: Srodowisko.hufiec('szczecin_pogodno', showChoragiew: false, showOkreg: false),
  ),
  emails: const [],
);
