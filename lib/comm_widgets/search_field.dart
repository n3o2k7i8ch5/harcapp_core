...
class SearchField extends StatefulWidget{
  ...
  static const EdgeInsets normMargin = EdgeInsets.only(
    ...
    static double height = Dimen.iconFootprint + normMargin.top;
    ...
    children: <Widget>[
      ...
      Padding(
        ...
        child: Material(
            ...
            borderRadius: BorderRadius.circular(Dimen.iconSize),
                  ...
                  children: <Widget>[
                    leading??(
                        ...
                        DefLeadClearableWidget(
                            ...
                            onCleared: (){
                              onTextCleared?.call();
                              setState(() {}); // To rebuild the "X" icon
                            }
                        ):
                        DefLeadWidget()
                    ),
                        ...
                        child: IgnorePointer(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintStyle: AppTextStyle(color: hintEnab_(context), fontSize: Dimen.textSizeBig)
                            ),
                          ),
                        )
                    ),
...
class DefLeadWidget extends StatelessWidget{

  const DefLeadWidget({super.key});
...
class DefLeadClearableWidget extends StatelessWidget {

  final TextEditingController controller;
  final bool Function()? canClearText;
  final FutureOr<void> Function()? onCleared;

  const DefLeadClearableWidget({
