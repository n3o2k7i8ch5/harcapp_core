...
class ApelEwanThumbnailWidget extends StatelessWidget{
  ...
  const ApelEwanThumbnailWidget(this.apelEwan, {this.variantId, this.onTap, super.key});
                        ...
                        child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              onTap: () => onTap?.call(apelEwan, variantId),
                              child: IgnorePointer(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Center(
                                          child: Text(
                                            apelEwan.variants[variantId]?.shortTitle??
                                                apelEwan.variants[variantId]?.title??
                                                apelEwan.variants.values.map((v) => v.shortTitle).firstWhere((s) => s != null, orElse: () => null)??
                                                apelEwan.variants.values.first.title,
