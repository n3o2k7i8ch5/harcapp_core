...
List<Konspekt> allKonspekts = [
  ...
  const Konspekt(
      ...
      description: 'Aby forma była skuteczna, uczestnicy muszą być w nią zaangażowani i nie mieć nic przeciwko rywalizacji (częściej jest to domeną chłopców niż dziewczyn). Forma bywa kontuzjogenna.'
          '<br>'
          '<br>Forma powinna być toczona na dużym terenie lesistym zapewniającym możliwość łatwego skrycia się.'
          '<br>'
          '<br>Zachowując opisane niżej zasady gry można nieznacznie zmienić jej cel dla uczestników, np:'
          '<ul>'
          '<li>Drużyny są dzielone na <b>atakującą</b> i <b>broniącą</b>. Drużyna <b>broniąca</b> ma wyznaczony <b>teren krytyczny</b> (np. między pięcioma drzewami). Drużyna atakująca ma wyznaczonego <b>sapera</b> - osobę, która posiada przedmiot będący <b>bombą</b> (np. menażkę).'
          '<br>'
          ...
          '</li>'
          '<li>Każda drużyna ma wyznaczoną <b>królową</b>. Drużyna przegrywa, jeśli straci <b>królową</b> niezależnie od tego ile osób pozostanie na końcu przy życiu. Przegrana drużyna natychmiast kończy grę.'
          '</ul>',
      steps: [
        ...
        KonspektStep(
            ...
            activeForm: false,
            content: 'Prowadzący przedstawia uczestnikom zasady gry:'
                '<ul>'
                '<li>W brze biorą udział co najmniej dwie grupy. Wygrywa grupa, której w której jako ostatniej zostaną "żywi" uczestnicy.</li>'
                '<li>Każdy uczestnik rozpoczyna mając na głowie beret. Jak uczestnik ma na głowie beret, tak długo jest "żywy".</li>'
                '<li>Berety można (a nawet trzeba) sobie wzajemnie ściągać z głowy.</li>'
                '<li>W grze nie wolno uderzać, gryźć, kopać, ani dotykać twarzy drugiej osoby.</li>'
                '<li>Gra toczy się na wybrany, jasny znak (np. trzykrotny gwizdek prowadzącego).</li>'
                '</ul>'
        ),
        ...
        KonspektStep(
            ...
            duration: Duration(minutes: 10),
            activeForm: false,
            content: 'Prowadzący dzieli uczestników na wybraną liczbę grup. Ważne, by każda grupa charakteryzowała się podobną sprawnością ruchową.'
        ),
        ...
        KonspektStep(
            ...
            activeForm: false,
            content: 'Każdy uczestnik zostaje oznaczenie przynależności do swojej grupy. Może to być szarfa naramienna o innym kolorze dla każdej grupy lub po prostu może to być beret o wybranym kolorze.'
                '<br'
                '<br>Jeżeli do gry używane są berety harcerskie, ważne jest, by nie miały one na sobie lilijek lub by berety były "wywrócone na lewą stronę" - inaczej łatwo o pocięte dłonie.'
        ),
        ...
        KonspektStep(
            ...
            activeForm: true,
            content: 'Grupy rozchodzą się po lesie i rozpoczyna się gra zgodnie z opisanymi wcześniej zasadami.'
        ),
        ...
        KonspektStep(
            ...
            duration: Duration(minutes: 5),
            activeForm: false,
            content: 'Prowadzący po zakończeniu gry podsumowuje jej przebieg z uczestnikami.'
        ),
        ...
        KonspektStep(
            ...
            duration: Duration(minutes: 30),
            activeForm: true,
            content: 'Grupy rozchodzą się po lesie i rozpoczyna się druga gra zgodnie z opisanymi wcześniej zasadami.'
        ),
        ...
        KonspektStep(
            ...
            duration: Duration(minutes: 5),
            activeForm: false,
            content: 'Prowadzący po zakończeniu rewanżu podsumowuje jej przebieg z uczestnikami.'
        ),
