...
KonspektStep step_sfery_rozwoju_sfera_ducha = KonspektStep(
    ...
    content: '<p style="text-align:justify;">'
        ...
        '<br>'
        '<br><u>Historia 1:</u>'
        '<br><i>Pewnego ranka jeden z nich bierze auto z pracy i jedzie do klienta montować elektrykę. Niestety w połowie drogi auto się psuje i staje na poboczu. Na zewnątrz jest minus piętnaście stopni.</i>'
        '</p>'
        '<ul>'
        ...
        'Wszyscy trzej mają absolutnie te same zdolności. Wszyscy trzej umieją otworzyć maskę i znaleźć problem, umieją zadzwonić do ubezpieczyciela i umieją dobiec na czas do klienta. Umieją to samo, a jednak każdy skorzystałby z zupełnie innych zdolności i w innym celu.</i>'
        '<br>'
        '<br>Prowadzący robi pauzę, po czym podsumowuje:'
        '<br>'
        '<br><i>Sfery funkcjonalne definiują co człowiek może. Sfera ducha definiuje jak i do czego ze swoich możliwości korzysta.</i>'
        '<br>'
