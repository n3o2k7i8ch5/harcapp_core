...
KonspektStep step_sfery_rozwoju_sfera_ducha = KonspektStep(
    ...
    content: '<p style="text-align:justify;">'
        ...
        '</p></blockquote>'
        '<p style="text-align:justify;">'
        'Prowadzący kładzie obok siebie w widocznym miejscu przykładowe zdolności z załącznika $attach_html_sfery_przyklady i opowiada następującą historię:'
        '</p>'
        '<blockquote>'
        '<p style="text-align:justify;">'
        ...
        '<li><p style="text-align:justify;">Gdyby autem jechał Bartek, nie ruszyłby się z auta, tylko natychmiast zadzwonił do ubezpieczyciela, żeby mu szybko przywieźli auto zastępcze.</p></li>'
        '<li><p style="text-align:justify;">Gdyby autem jechał Cezary, wziąłby narzędzia, zostawił samochód i pobiegł resztę trasy pieszo, żeby wykonać u klienta zlecenie.</p></li>'
        '</ul>'
        '<p style="text-align:justify;">'
        'Wszyscy trzej umieją to samo, a jednak każdy skorzystałby z zupełnie innych zdolności i w innym celu.'
        '<br>'
        '<br>Sfery funkcjonalne definiują co człowiek może. Sfera ducha definiuje jak i do czego ze swoich możliwości korzysta.'
        '</p>'
        '</blockquote>'
        '<p style="text-align:justify;">'
        'Prowadzący kładzie we wspólnej przestrzeni, obok kartki "sfery funkcjonalne", kartkę "sfera ducha" z załącznika $attach_html_sfery.'
        '</p>'
);
