    ...
    steps: [
      ...
      KonspektStep(
          ...
          content: '<p style="text-align:justify;">'
              ...
              '<br>'
              '<br>Do części scenariuszy prowadzący powinien zadać pytania dodatkowe, gdy dyskusja zad nimi się zakończy.'
              '</p>'
              '<ol>'
              ...
              '<p style="text-align:justify;">'
              '<b>Scenariusz 1:</b>'
              '<br><i>Wędrownik w wieku 10 lat zlożył przyżeczenie "bez Boga", lecz w trakcie nauki w liceum się nawrócił. Na początku obozu zapytał drużynowego, czy mógłby kiedyś złożyć ponownie Przyrzeczenie Harcerskie.'
              '<br>'
              ...
              '<br><b>Rozwiązanie:</b>'
              '<br>'
              '<br>Przyrzeczenie Harcerskie nie jest świętością, prawem, ani absolutem - jest narzędziem wychowawczym. W pierwszej kolejności dobrze, jeśli drużynowy podejmie nienahalną próbę porozmawiania z harcerzem na temat powodów, dla których nie zgadza się on ze swoimi rodzicami.'
              '<br>'
              '<br>Jeżeli harcerz będzie cały czas uparty - nie zmuszanie go do czegokolwiek będzie wychowawczo nieskuteczne (warto przedstawić ten argument rodzicom). Najlepiej pozwolić harcerzowi złożyć Przyczenie w takiej formule, w jakiej będzie chciał. Jeśli rodzice uznają to za zbyt daleko idące - zawsze mogą zabrać dziecko z harcerstwa.'
              '<br>'
              '<br>Warto, by drużynowy w takim wypadku i tak podejmował pracę nad duchowością harcerza w konteście religijnym w trakcie dalszego procesu wychowawczego (przygotowanie do i chodzenie na mszę, kontakt z tradycjami religijnymi, kapelanami, wychowanie przez śpiewanie, etc.).'
              '</p>'
              '</li>'
