...
///   optional label). No tooltip, no blur — blends in next to other
///   [SimpleButton.from] buttons. Use for action rows on web/mobile pages where
///   a "regular" button look is expected.
